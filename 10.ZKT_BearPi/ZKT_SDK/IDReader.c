...
/*命令包发送处理*/
static uint8_t CMD_Packet_Send_Handler(uint8_t CMD_NUMBER)
{
    uint8_t count = 0 ;
...
{
    if(HAL_OK == CMD_Packet_Send_Handler(0))
        return 0 ;
...
{
    if(HAL_OK == CMD_Packet_Send_Handler(1))
        return 0 ;
...
{
    if(HAL_OK == CMD_Packet_Send_Handler(2))
        return 0 ;
...
{
    if(HAL_OK == CMD_Packet_Send_Handler(3))
        return 0 ;
...
{
    if(HAL_OK == CMD_Packet_Send_Handler(4))
        return 0 ;
